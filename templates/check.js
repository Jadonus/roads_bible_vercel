...
if (ls == null) {
    ...
    swal({
        ...
        if (willDelete) {
            ...
            var url = "https://beta.ourmanna.com/api/v1/get";
            ...
            xhr_1.onload = function () {
                if (xhr_1.status === 200) {
                    ...
                    console.log("Error: " + xhr_1.status);
                }
            };
            xhr_1.send();
            var arrayOfStrings_1 = [
                "Psalm100",
                "romans-road",
                "Psalm23",
                "Psalm95",
            ...
            function searchArray() {
                ...
                var searchResults = [];
                for (var i = 0; i < arrayOfStrings_1.length; i++) {
                    if (arrayOfStrings_1[i].toLowerCase().includes(searchInput)) {
                        searchResults.push(arrayOfStrings_1[i]);
                    }
                }
            ...
            function activateTopItem() {
                var topItem = document.querySelector("#searchResults li:first-child a");
                if (topItem) {
